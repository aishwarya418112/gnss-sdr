...
GpsL1CaPcpsAcquisitionGPS::GpsL1CaPcpsAcquisitionGPS(
...
void GpsL1CaPcpsAcquisitionGPS::stop_acquisition()
{
    acquisition_->set_active(false);
}


void GpsL1CaPcpsAcquisitionGPS::set_threshold(float threshold)
{
...
void GpsL1CaPcpsAcquisitionGPS::set_doppler_max(unsigned int doppler_max)
{
...
void GpsL1CaPcpsAcquisitionGPS::set_doppler_step(unsigned int doppler_step)
{
...
void GpsL1CaPcpsAcquisitionGPS::set_doppler_center(int doppler_center)
{
...
void GpsL1CaPcpsAcquisitionGPS::set_gnss_synchro(Gnss_Synchro* gnss_synchro)
{
...
signed int GpsL1CaPcpsAcquisitionGPS::mag()
{
    return acquisition_->mag();
}


void GpsL1CaPcpsAcquisitionGPS::init()
{
    acquisition_->init();
}


void GpsL1CaPcpsAcquisitionGPS::set_local_code()
{
...
void GpsL1CaPcpsAcquisitionGPS::reset()
{
    acquisition_->set_active(true);
}


void GpsL1CaPcpsAcquisitionGPS::set_state(int state)
{
    acquisition_->set_state(state);
}


void GpsL1CaPcpsAcquisitionGPS::connect(gr::top_block_sptr top_block)
{
...
void GpsL1CaPcpsAcquisitionGPS::disconnect(gr::top_block_sptr top_block)
{
    if (item_type_ == "gr_complex" || item_type_ == "cshort")
        {
...
gr::basic_block_sptr GpsL1CaPcpsAcquisitionGPS::get_left_block()
{
    if (item_type_ == "gr_complex" || item_type_ == "cshort")
        {
            return acquisition_;
...
gr::basic_block_sptr GpsL1CaPcpsAcquisitionGPS::get_right_block()
{
    return acquisition_;
}


void GpsL1CaPcpsAcquisitionGPS::set_resampler_latency(uint32_t latency_samples)
{
