 ...
 */
class GpsL1CaPcpsAcquisitionGPS : public AcquisitionInterface
{
public:
    GpsL1CaPcpsAcquisitionGPS(
        const ConfigurationInterface* configuration,
        const std::string& role,
        unsigned int in_streams,
        unsigned int out_streams);

    ~GpsL1CaPcpsAcquisitionGPS() = default;
    ...
    /*!
     * \brief Returns "GPS_L1_CA_PCPS_Acquisition_GPS"
     */
    inline std::string implementation() override
    {
        return "GPS_L1_CA_PCPS_AcquisitionGPS";
    }
...
/** \} */
/** \} */
#endif  // GNSS_SDR_GPS_L1_CA_PCPS_ACQUISITION_GPS_H
