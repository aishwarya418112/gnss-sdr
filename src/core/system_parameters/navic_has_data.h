/*!
 * \file navic_has_data.h
 * \brief  Class for Navic HAS message type 1 data storage
...
#ifndef GNSS_SDR_NAVIC_HAS_DATA_H
#define GNSS_SDR_NAVIC_HAS_DATA_H
...
/*!
 * \brief This class is a storage for Navic HAS message type 1, as defined in
 * Navic High Accuracy Service E6-B Signal-In-Space Message Specification v1.2
 * (April 2020).
 */
class Navic_HAS_data
{
public:
    Navic_HAS_data() = default;
...
/** \} */
/** \} */
#endif  // GNSS_SDR_NAVIC_HAS_DATA_H
