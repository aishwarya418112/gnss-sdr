...
#ifndef GNSS_SDR_NAVIC_IONO_H
#define GNSS_SDR_NAVIC_IONO_H
...
/*!
 * \brief This class is a storage for the NAVIC IONOSPHERIC data as described in Navic ICD paragraph 5.1.6
 *
