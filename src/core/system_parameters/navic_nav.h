/*!
 * \file Navic_NAV.h
 * \brief Navic INAV mesage constants
...
#ifndef GNSS_SDR_NAVIC_INAV_H
#define GNSS_SDR_NAVIC_INAV_H
...
// Navic INAV message structure
constexpr double NAVIC_INAV_PAGE_PART_WITH_PREABLE_SECONDS = 2.04;  //!< Page Duration + (Navic I/NAV Preamble bits)*(Navic E5b-I tiered Code Period(seconds))
constexpr uint32_t NAVIC_INAV_PAGE_SYMBOLS = 500;                   //!< The complete Navic INAV page length
constexpr int32_t NAVIC_INAV_PREAMBLE_LENGTH_BITS = 10;
constexpr int32_t NAVIC_INAV_PREAMBLE_PERIOD_SYMBOLS = 250;
constexpr int32_t NAVIC_INAV_PAGE_PART_SYMBOLS = 250;  //!< Each Navic INAV pages are composed of two parts (even and odd) each of 250 symbols, including preamble. See Navic ICD 4.3.2
constexpr int32_t NAVIC_INAV_PAGE_PART_SECONDS = 1;    // a page part last 1 sec
constexpr int32_t NAVIC_INAV_PAGE_PART_MS = 1000;      // a page part last 1 sec
constexpr int32_t NAVIC_INAV_PAGE_SECONDS = 2;         // a full page last 2 sec
constexpr int32_t NAVIC_INAV_INTERLEAVER_ROWS = 8;
constexpr int32_t NAVIC_INAV_INTERLEAVER_COLS = 30;
constexpr int32_t NAVIC_TELEMETRY_RATE_BITS_SECOND = 250;  // bps
constexpr int32_t NAVIC_PAGE_TYPE_BITS = 6;
constexpr int32_t NAVIC_DATA_JK_BITS = 128;
constexpr int32_t NAVIC_DATA_FRAME_BITS = 196;
constexpr int32_t NAVIC_DATA_FRAME_BYTES = 25;
constexpr char NAVIC_INAV_PREAMBLE[11] = "0101100000";
