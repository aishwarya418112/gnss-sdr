...
#ifndef GNSS_SDR_NAVIC_UTC_MODEL_H
#define GNSS_SDR_NAVIC_UTC_MODEL_H
...
/*!
 * \brief This class is a storage for the NAVIC UTC MODEL data as described in Navic ICD
 * https://www.gsc-europa.eu/sites/default/files/sites/all/files/Navic-OS-SIS-ICD.pdf
 * paragraph 5.1.7
 */
class Navic_Utc_Model
{
public:
    /*!
     * Default constructor
     */
    Navic_Utc_Model() = default;
...
/** \} */
/** \} */
#endif  // GNSS_SDR_NAVIC_UTC_MODEL_H
