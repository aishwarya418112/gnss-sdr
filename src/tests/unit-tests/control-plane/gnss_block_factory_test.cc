...
TEST(GNSSBlockFactoryTest, InstantiateFileSignalSource)
{
    ...
    std::string filename = path + "signal_samples/NAVIC_L5_CA_ID_1_Fs_4Msps_2ms.dat";
...
TEST(GNSSBlockFactoryTest, InstantiateNavicL5CaPcpsAcquisition)
{
    std::shared_ptr<InMemoryConfiguration> configuration = std::make_shared<InMemoryConfiguration>();
    configuration->set_property("Acquisition.implementation", "NAVIC_L5_CA_PCPS_Acquisition");
    std::unique_ptr<GNSSBlockFactory> factory = std::make_unique<GNSSBlockFactory>();
    ...
    EXPECT_STREQ("NAVIC_L5_CA_PCPS_Acquisition", acquisition->implementation().c_str());
}


/*TEST(GNSSBlockFactoryTest, InstantiateNavicL5CaPcpsQuickSyncAcquisition)
{
    std::shared_ptr<InMemoryConfiguration> configuration = std::make_shared<InMemoryConfiguration>();
    configuration->set_property("Acquisition.implementation", "NAVIC_L5_CA_PCPS_QuickSync_Acquisition");
    std::shared_ptr<GNSSBlockFactory> factory = std::make_shared<GNSSBlockFactory>();
    std::shared_ptr<GNSSBlockInterface> acq_ = factory->GetBlock(configuration.get(), "Acquisition", 1, 0);
    std::shared_ptr<AcquisitionInterface> acquisition = std::dynamic_pointer_cast<AcquisitionInterface>(acq_);
    EXPECT_STREQ("Acquisition", acquisition->role().c_str());
    EXPECT_STREQ("NAVIC_L5_CA_PCPS_QuickSync_Acquisition", acquisition->implementation().c_str());
}
...
TEST(GNSSBlockFactoryTest, InstantiateNavicL5CaDllPllTracking)
{
    std::shared_ptr<InMemoryConfiguration> configuration = std::make_shared<InMemoryConfiguration>();
    configuration->set_property("Tracking.implementation", "NAVIC_L5_CA_DLL_PLL_Tracking");
    std::unique_ptr<GNSSBlockFactory> factory = std::make_unique<GNSSBlockFactory>();
    ...
    EXPECT_STREQ("NAVIC_L5_CA_DLL_PLL_Tracking", tracking->implementation().c_str());
}


TEST(GNSSBlockFactoryTest, InstantiateNavicL5CaTcpConnectorTracking)
{
    std::shared_ptr<InMemoryConfiguration> configuration = std::make_shared<InMemoryConfiguration>();
    configuration->set_property("Tracking.implementation", "NAVIC_L5_CA_TCP_CONNECTOR_Tracking");
    std::unique_ptr<GNSSBlockFactory> factory = std::make_unique<GNSSBlockFactory>();
    std::shared_ptr<GNSSBlockInterface> trk_ = factory->GetBlock(configuration.get(), "Tracking", 1, 1);
    std::shared_ptr<TrackingInterface> tracking = std::dynamic_pointer_cast<TrackingInterface>(trk_);
    EXPECT_STREQ("Tracking", tracking->role().c_str());
    EXPECT_STREQ("NAVIC_L5_CA_TCP_CONNECTOR_Tracking", tracking->implementation().c_str());
}
...
TEST(GNSSBlockFactoryTest, InstantiateNavicL5CaTelemetryDecoder)
{
    std::shared_ptr<InMemoryConfiguration> configuration = std::make_shared<InMemoryConfiguration>();
    configuration->set_property("TelemetryDecoder.implementation", "NAVIC_L5_CA_Telemetry_Decoder");
    std::unique_ptr<GNSSBlockFactory> factory = std::make_unique<GNSSBlockFactory>();
    ...
    EXPECT_STREQ("NAVIC_L5_CA_Telemetry_Decoder", telemetry_decoder->implementation().c_str());
}
...
{
    std::shared_ptr<InMemoryConfiguration> configuration = std::make_shared<InMemoryConfiguration>();
    configuration->set_property("Channels_L5.count", "2");
    configuration->set_property("Channels_1E.count", "0");
    configuration->set_property("Channels.in_acquisition", "2");
    configuration->set_property("Tracking_L5.implementation", "NAVIC_L5_CA_DLL_PLL_Tracking");
    configuration->set_property("TelemetryDecoder_L5.implementation", "NAVIC_L5_CA_Telemetry_Decoder");
    configuration->set_property("Channel0.item_type", "gr_complex");
    configuration->set_property("Acquisition_L5.implementation", "NAVIC_L5_CA_PCPS_Acquisition");
...
TEST(GNSSBlockFactoryTest, InstantiateNavicL5CaObservables)
{
    std::shared_ptr<InMemoryConfiguration> configuration = std::make_shared<InMemoryConfiguration>();
