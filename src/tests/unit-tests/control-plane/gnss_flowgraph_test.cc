...
TEST(GNSSFlowgraph /*unused*/, InstantiateConnectStartStopOldNotation /*unused*/)
{
    ...
    config->set_property("GNSS-SDR.SUPL_navic_enabled", "false");
    ...
    config->set_property("Channels_L5.count", "1");
    ...
    config->set_property("Acquisition_L5.threshold", "1");
    config->set_property("Acquisition_L5.doppler_max", "5000");
    config->set_property("Tracking_L5.implementation", "NAVIC_L5_CA_DLL_PLL_Tracking");
    config->set_property("TelemetryDecoder_L5.implementation", "NAVIC_L5_CA_Telemetry_Decoder");
...
TEST(GNSSFlowgraph /*unused*/, InstantiateConnectStartStop /*unused*/)
{
    ...
    config->set_property("SignalSource.filename", filename);
    config->set_property("SignalConditioner.implementation", "Pass_Through");
    config->set_property("Channels_L5.count", "8");
    config->set_property("Channels.in_acquisition", "1");
    config->set_property("Channel.signal", "L5");
    config->set_property("Acquisition_L5.implementation", "NAVIC_L5_CA_PCPS_Acquisition");
    config->set_property("Acquisition_L5.threshold", "1");
    config->set_property("Acquisition_L5.doppler_max", "5000");
    config->set_property("Tracking_L5.implementation", "NAVIC_L5_CA_DLL_PLL_Tracking");
...
TEST(GNSSFlowgraph /*unused*/, InstantiateConnectStartStopHybrid /*unused*/)
{
    ...
    config->set_property("Acquisition_L50.implementation", "NAVIC_L5_CA_PCPS_Acquisition");
    config->set_property("Acquisition_L50.threshold", "1");
    config->set_property("Acquisition_L50.doppler_max", "5000");
    config->set_property("Acquisition_L51.implementation", "NAVIC_L5_CA_PCPS_Acquisition");
    config->set_property("Acquisition_L51.threshold", "1");
    config->set_property("Acquisition_L51.doppler_max", "5000");
    config->set_property("Acquisition_L52.implementation", "NAVIC_L5_CA_PCPS_Acquisition");
    config->set_property("Acquisition_L52.threshold", "1");
    config->set_property("Acquisition_L52.doppler_max", "5000");
    config->set_property("Acquisition_L53.implementation", "NAVIC_L5_CA_PCPS_Acquisition");
    config->set_property("Acquisition_L53.threshold", "1");
    config->set_property("Acquisition_L53.doppler_max", "5000");
    config->set_property("Acquisition_L54.implementation", "NAVIC_L5_CA_PCPS_Acquisition");
    config->set_property("Acquisition_L54.threshold", "1");
    config->set_property("Acquisition_L54.doppler_max", "5000");
    config->set_property("Acquisition_L55.implementation", "NAVIC_L5_CA_PCPS_Acquisition");
    config->set_property("Acquisition_L55.threshold", "1");
    config->set_property("Acquisition_L55.doppler_max", "5000");
    config->set_property("Acquisition_L56.implementation", "NAVIC_L5_CA_PCPS_Acquisition");
    config->set_property("Acquisition_L56.threshold", "1");
    config->set_property("Acquisition_L56.doppler_max", "5000");
    config->set_property("Acquisition_L57.implementation", "NAVIC_L5_CA_PCPS_Acquisition");
    config->set_property("Acquisition_L57.threshold", "1");
    config->set_property("Acquisition_L57.doppler_max", "5000");
    ...
    config->set_property("Tracking_L50.implementation", "NAVIC_L5_CA_DLL_PLL_Tracking");
    config->set_property("Tracking_L51.implementation", "NAVIC_L5_CA_DLL_PLL_Tracking");
    config->set_property("Tracking_L52.implementation", "NAVIC_L5_CA_DLL_PLL_Tracking");
    config->set_property("Tracking_L53.implementation", "NAVIC_L5_CA_DLL_PLL_Tracking");
    config->set_property("Tracking_L54.implementation", "NAVIC_L5_CA_DLL_PLL_Tracking");
    config->set_property("Tracking_L55.implementation", "NAVIC_L5_CA_DLL_PLL_Tracking");
    config->set_property("Tracking_L56.implementation", "NAVIC_L5_CA_DLL_PLL_Tracking");
    config->set_property("Tracking_L57.implementation", "NAVIC_L5_CA_DLL_PLL_Tracking");
    ...
    config->set_property("TelemetryDecoder_L50.implementation", "NAVIC_L5_CA_Telemetry_Decoder");
    config->set_property("TelemetryDecoder_L51.implementation", "NAVIC_L5_CA_Telemetry_Decoder");
    config->set_property("TelemetryDecoder_L52.implementation", "NAVIC_L5_CA_Telemetry_Decoder");
    config->set_property("TelemetryDecoder_L53.implementation", "NAVIC_L5_CA_Telemetry_Decoder");
    config->set_property("TelemetryDecoder_L54.implementation", "NAVIC_L5_CA_Telemetry_Decoder");
    config->set_property("TelemetryDecoder_L55.implementation", "NAVIC_L5_CA_Telemetry_Decoder");
    config->set_property("TelemetryDecoder_L56.implementation", "NAVIC_L5_CA_Telemetry_Decoder");
    config->set_property("TelemetryDecoder_L57.implementation", "NAVIC_L5_CA_Telemetry_Decoder");
