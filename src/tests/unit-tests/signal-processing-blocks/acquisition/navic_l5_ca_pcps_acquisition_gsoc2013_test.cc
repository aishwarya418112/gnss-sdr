/*!
 * \file navic_l5_ca_pcps_acquisition_gsoc2013_test.cc
 * \brief  This class implements an acquisition test for
 * NavicLL5aPcpsAcquisition class.
...
class NavicLL5aPcpsAcquisitionGSoC2013Test_msg_rx;

using NavicLL5aPcpsAcquisitionGSoC2013Test_msg_rx_sptr = gnss_shared_ptr<NavicLL5aPcpsAcquisitionGSoC2013Test_msg_rx>;

NavicLL5aPcpsAcquisitionGSoC2013Test_msg_rx_sptr NavicLL5aPcpsAcquisitionGSoC2013Test_msg_rx_make(Concurrent_Queue<int>& queue);


class NavicLL5aPcpsAcquisitionGSoC2013Test_msg_rx : public gr::block
{
private:
    friend NavicLL5aPcpsAcquisitionGSoC2013Test_msg_rx_sptr NavicLL5aPcpsAcquisitionGSoC2013Test_msg_rx_make(Concurrent_Queue<int>& queue);
    void msg_handler_channel_events(const pmt::pmt_t msg);
    explicit NavicLL5aPcpsAcquisitionGSoC2013Test_msg_rx(Concurrent_Queue<int>& queue);
    Concurrent_Queue<int>& channel_internal_queue;

public:
    int rx_message;
    ~NavicLL5aPcpsAcquisitionGSoC2013Test_msg_rx();  //!< Default destructor
};


NavicLL5aPcpsAcquisitionGSoC2013Test_msg_rx_sptr NavicLL5aPcpsAcquisitionGSoC2013Test_msg_rx_make(Concurrent_Queue<int>& queue)
{
    return NavicLL5aPcpsAcquisitionGSoC2013Test_msg_rx_sptr(new NavicLL5aPcpsAcquisitionGSoC2013Test_msg_rx(queue));
}


void NavicLL5aPcpsAcquisitionGSoC2013Test_msg_rx::msg_handler_channel_events(const pmt::pmt_t msg)
{
    try
        {
...
NavicLL5aPcpsAcquisitionGSoC2013Test_msg_rx::NavicLL5aPcpsAcquisitionGSoC2013Test_msg_rx(Concurrent_Queue<int>& queue) : gr::block("NavicLL5aPcpsAcquisitionGSoC2013Test_msg_rx", gr::io_signature::make(0, 0, 0), gr::io_signature::make(0, 0, 0)), channel_internal_queue(queue)
{
    ...
    this->set_msg_handler(pmt::mp("events"),
        ...
        boost::bind(&NavicLL5aPcpsAcquisitionGSoC2013Test_msg_rx::msg_handler_channel_events, this, boost::placeholders::_1));
#else
        boost::bind(&NavicLL5aPcpsAcquisitionGSoC2013Test_msg_rx::msg_handler_channel_events, this, _1));
#endif
#endif
    rx_message = 0;
}

NavicLL5aPcpsAcquisitionGSoC2013Test_msg_rx::~NavicLL5aPcpsAcquisitionGSoC2013Test_msg_rx() = default;


// ###########################################################

class NavicLL5aPcpsAcquisitionGSoC2013Test : public ::testing::Test
{
protected:
    NavicLL5aPcpsAcquisitionGSoC2013Test()
    {
    ...
    ~NavicLL5aPcpsAcquisitionGSoC2013Test() = default;
    ...
    std::shared_ptr<NavicLL5aPcpsAcquisition> acquisition;
...
void NavicLL5aPcpsAcquisitionGSoC2013Test::init()
{
    message = 0;
...
void NavicLL5aPcpsAcquisitionGSoC2013Test::config_1()
{
    ...
    config->set_property("InputFilter.ampl5_begin", "1.0");
    config->set_property("InputFilter.ampl5_end", "1.0");
    ...
    config->set_property("Acquisition_L5.implementation", "NAVIC_L5_CA_PCPS_Acquisition");
    config->set_property("Acquisition_L5.item_type", "gr_complex");
    config->set_property("Acquisition_L5.coherent_integration_time_ms",
        std::to_string(integration_time_ms));
    config->set_property("Acquisition_L5.max_dwells", "1");
    // config->set_property("Acquisition_L5.threshold", "2.5");
    config->set_property("Acquisition_L5.pfa", "0.001");
    config->set_property("Acquisition_L5.doppler_max", "10000");
    config->set_property("Acquisition_L5.doppler_step", "250");
    config->set_property("Acquisition_L5.bit_transition_flag", "false");
    config->set_property("Acquisition_L5.dump", "false");
}


void NavicLL5aPcpsAcquisitionGSoC2013Test::config_2()
{
    gnss_synchro.Channel_ID = 0;
    gnss_synchro.System = 'N';
    std::string signal = "L5";
    signal.copy(gnss_synchro.Signal, 2, 0);
...
void NavicLL5aPcpsAcquisitionGSoC2013Test::start_queue()
{
    stop = false;
    ch_thread = std::thread(&NavicLL5aPcpsAcquisitionGSoC2013Test::wait_message, this);
}


void NavicLL5aPcpsAcquisitionGSoC2013Test::wait_message()
{
...
void NavicLL5aPcpsAcquisitionGSoC2013Test::process_message()
{
    if (message == 1)
        {
            detection_counter++;
...
void NavicLL5aPcpsAcquisitionGSoC2013Test::stop_queue()
{
    stop = true;
}


TEST_F(NavicLL5aPcpsAcquisitionGSoC2013Test, Instantiate)
{
    config_1();
    acquisition = std::make_shared<NavicLL5aPcpsAcquisitionNAVIC>(config.get(), "Acquisition", 1, 0);
}


TEST_F(NavicLL5aPcpsAcquisitionGSoC2013Test, ConnectAndRun)
{
    ...
    config_1();
    acquisition = std::make_shared<NavicLL5aPcpsAcquisitionNAVIC>(config.get(), "Acquisition_L5", 1, 0);
    auto msg_rx = NavicLL5aPcpsAcquisitionGSoC2013Test_msg_rx_make(channel_internal_queue);
...
TEST_F(NavicLL5aPcpsAcquisitionGSoC2013Test, ValidationOfResults)
{
    config_1();
    queue = std::make_shared<Concurrent_Queue<pmt::pmt_t>>();
    top_block = gr::make_top_block("Acquisition test");

    acquisition = std::make_shared<NavicLL5aPcpsAcquisition>(config.get(), "Acquisition_L5", 1, 0);
    auto msg_rx = NavicLL5aPcpsAcquisitionGSoC2013Test_msg_rx_make(channel_internal_queue);
...
TEST_F(NavicLL5aPcpsAcquisitionGSoC2013Test, ValidationOfResultsProbabilities)
{
    config_2();
    queue = std::make_shared<Concurrent_Queue<pmt::pmt_t>>();
    top_block = gr::make_top_block("Acquisition test");
    ...
    ASSERT_NO_THROW({
        acquisition->set_doppler_max(config->property("Acquisition_L5.doppler_max", 10000));
    }) << "Failure setting doppler_max.";

    ASSERT_NO_THROW({
        acquisition->set_doppler_step(config->property("Acquisition_L5.doppler_step", 500));
    }) << "Failure setting doppler_step.";
