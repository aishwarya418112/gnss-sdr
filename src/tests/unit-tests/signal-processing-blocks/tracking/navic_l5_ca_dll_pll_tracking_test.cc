/*!
 * \file navic_l5_ca_dll_pll_tracking_test.cc
 * \brief  This class implements a tracking test for NAVIC_L5_CA_DLL_PLL_Tracking
...
class NavicL5CADllPllTrackingTest_msg_rx;

using NavicL5CADllPllTrackingTest_msg_rx_sptr = gnss_shared_ptr<NavicL5CADllPllTrackingTest_msg_rx>;

NavicL5CADllPllTrackingTest_msg_rx_sptr NavicL5CADllPllTrackingTest_msg_rx_make();

class NavicL5CADllPllTrackingTest_msg_rx : public gr::block
{
private:
    friend NavicL5CADllPllTrackingTest_msg_rx_sptr NavicL5CADllPllTrackingTest_msg_rx_make();
    void msg_handler_channel_events(const pmt::pmt_t msg);
    NavicL5CADllPllTrackingTest_msg_rx();

public:
    int rx_message;
    ~NavicL5CADllPllTrackingTest_msg_rx();  //!< Default destructor
};


NavicL5CADllPllTrackingTest_msg_rx_sptr NavicL5CADllPllTrackingTest_msg_rx_make()
{
    return NavicL5CADllPllTrackingTest_msg_rx_sptr(new NavicL5CADllPllTrackingTest_msg_rx());
}


void NavicL5CADllPllTrackingTest_msg_rx::msg_handler_channel_events(const pmt::pmt_t msg)
{
    try
        {
...
NavicL5CADllPllTrackingTest_msg_rx::NavicL5CADllPllTrackingTest_msg_rx() : gr::block("NavicL5CADllPllTrackingTest_msg_rx", gr::io_signature::make(0, 0, 0), gr::io_signature::make(0, 0, 0))
{
    ...
    this->set_msg_handler(pmt::mp("events"),
        ...
        boost::bind(&NavicL5CADllPllTrackingTest_msg_rx::msg_handler_channel_events, this, boost::placeholders::_1));
#else
        boost::bind(&NavicL5CADllPllTrackingTest_msg_rx::msg_handler_channel_events, this, _1));
#endif
#endif
    rx_message = 0;
}
...
NavicL5CADllPllTrackingTest_msg_rx::~NavicL5CADllPllTrackingTest_msg_rx() = default;


// ###########################################################

class NavicL5CADllPllTrackingTest : public ::testing::Test
{
public:
    ...
    std::string p5;
    std::string p6;
    std::string implementation = "NAVIC_L5_CA_DLL_PLL_Tracking";
    ...
    ~NavicL5CADllPllTrackingTest() = default;
...
int NavicL5CADllPllTrackingTest::configure_generator(double CN0_dBHz, int file_idx)
{
...
int NavicL5CADllPllTrackingTest::generate_signal()
{
    int child_status;
...
void NavicL5CADllPllTrackingTest::configure_receiver(
    ...
    int extend_correlation_symbols)
{
    ...
    // Set Tracking
    config->set_property("Tracking_L5.implementation", implementation);
    config->set_property("Tracking_L5.item_type", "gr_complex");
    config->set_property("Tracking_L5.pll_bw_hz", std::to_string(PLL_wide_bw_hz));
    config->set_property("Tracking_L5.dll_bw_hz", std::to_string(DLL_wide_bw_hz));
    config->set_property("Tracking_L5.early_late_space_chips", "0.5");
    config->set_property("Tracking_L5.extend_correlation_symbols", std::to_string(extend_correlation_symbols));
    config->set_property("Tracking_L5.pll_bw_narrow_hz", std::to_string(PLL_narrow_bw_hz));
    config->set_property("Tracking_L5.dll_bw_narrow_hz", std::to_string(DLL_narrow_bw_hz));
    config->set_property("Tracking_L5.early_late_space_narrow_chips", "0.5");
    config->set_property("Tracking_L5.dump", "true");
    config->set_property("Tracking_L5.dump_filename", "./tracking_ch_");

    std::cout << "*****************************************\n";
    std::cout << "*** Tracking configuration parameters ***\n";
    std::cout << "*****************************************\n";
    std::cout << "pll_bw_hz: " << config->property("Tracking_L5.pll_bw_hz", 0.0) << " Hz\n";
    std::cout << "dll_bw_hz: " << config->property("Tracking_L5.dll_bw_hz", 0.0) << " Hz\n";
    std::cout << "pll_bw_narrow_hz: " << config->property("Tracking_L5.pll_bw_narrow_hz", 0.0) << " Hz\n";
    std::cout << "dll_bw_narrow_hz: " << config->property("Tracking_L5.dll_bw_narrow_hz", 0.0) << " Hz\n";
    std::cout << "extend_correlation_symbols: " << config->property("Tracking_L5.extend_correlation_symbols", 0) << " Symbols\n";
    std::cout << "*****************************************\n";
    std::cout << "*****************************************\n";
}


std::vector<double> NavicL5CADllPllTrackingTest::check_results_doppler(arma::vec& true_time_s,
    arma::vec& true_value,
    arma::vec& meas_time_s,
    arma::vec& meas_value,
    double& mean_error,
...
std::vector<double> NavicL5CADllPllTrackingTest::check_results_acc_carrier_phase(arma::vec& true_time_s,
    arma::vec& true_value,
    arma::vec& meas_time_s,
    arma::vec& meas_value,
    double& mean_error,
...
std::vector<double> NavicL5CADllPllTrackingTest::check_results_codephase(arma::vec& true_time_s,
    arma::vec& true_value,
    arma::vec& meas_time_s,
    arma::vec& meas_value,
    double& mean_error,
...
TEST_F(NavicL5CADllPllTrackingTest, ValidationOfResults)
{
    // *************************************************
    ...
    for (unsigned int config_idx = 0; config_idx < PLL_wide_bw_values.size(); config_idx++)
        {
            ...
            for (unsigned int current_cn0_idx = 0; current_cn0_idx < generator_CN0_values.size(); current_cn0_idx++)
                {
                    ...
                    if (!FLAGS_enable_external_signal_file)
                        {
                            ...
                            std::string true_obs_file = std::string("./navic_l5_ca_obs_prn");
                            ...
                            std::cout << "Initial Doppler [Hz]=" << true_obs_data.doppler_l5_hz << " Initial code delay [Chips]=" << true_obs_data.prn_delay_chips << '\n';
                            acq_doppler_hz = true_obs_data.doppler_l5_hz;
                            acq_delay_samples = (NAVIC_L5_CA_CODE_LENGTH_CHIPS - true_obs_data.prn_delay_chips / NAVIC_L5_CA_CODE_LENGTH_CHIPS) * static_cast<double>(baseband_sampling_freq) * NAVIC_L5_CA_CODE_PERIOD_S;
                    ...
                    std::shared_ptr<GNSSBlockInterface> trk_ = factory->GetBlock(config.get(), "Tracking_L5", 1, 1);
                    std::shared_ptr<TrackingInterface> tracking = std::dynamic_pointer_cast<TrackingInterface>(trk_);

                    auto msg_rx = NavicL5CADllPllTrackingTest_msg_rx_make();
                    ...
                    while (trk_dump.read_binary_obs())
                        {
                            ...
                            double delay_chips = NAVIC_L5_CA_CODE_LENGTH_CHIPS - NAVIC_L5_CA_CODE_LENGTH_CHIPS * (fmod((static_cast<double>(trk_dump.PRN_start_sample_count) + trk_dump.aux1) / static_cast<double>(baseband_sampling_freq), 1.0e-3) / 1.0e-3);
                                    ...
                                    while (true_obs_data.read_binary_obs())
                                        {
                                            ...
                                            true_Doppler_Hz(epoch_counter) = true_obs_data.doppler_l5_hz;
                                    ...
                                    if (!initial_meas_point.empty() and tracking_last_msg != 3)
                                        {
                                            ...
                                            for (double code_phase_error_chip : code_phase_error_chips)
                                                {
                                                    code_phase_error_meters.push_back(NAVIC_L5_CA_CHIP_PERIOD_S * code_phase_error_chip * SPEED_OF_LIGHT_M_S);
                                                }
            ...
            // ***** STEP 7: Plot results *****
            // ********************************
            if (FLAGS_plot_navic_l5_tracking_test == true)
                {
                    const std::string gnuplot_executable(FLAGS_gnuplot_executable);
                    if (gnuplot_executable.empty())
                        {
                            std::cout << "WARNING: Although the flag plot_navic_l5_tracking_test has been set to TRUE,\n";
                                    ...
                                    if (FLAGS_plot_detail_level >= 2)
                                        {
                                            for (unsigned int current_cn0_idx = 0; current_cn0_idx < generator_CN0_values.size(); current_cn0_idx++)
                                                {
                                                    ...
                                                    g1.set_title(std::to_string(generator_CN0_values.at(current_cn0_idx)) + " dB-Hz, " + "PLL/DLL BW: " + std::to_string(PLL_wide_bw_values.at(config_idx)) + "," + std::to_string(DLL_wide_bw_values.at(config_idx)) + " Hz" + "NAVIC L5 C/A (PRN #" + std::to_string(FLAGS_test_satellite_PRN) + ")");
                                                    g1.set_grid();
                                            ...
                                            for (unsigned int current_cn0_idx = 0; current_cn0_idx < generator_CN0_values.size(); current_cn0_idx++)
                                                {
                                                    g2.reset_plot();
                                                    g2.set_title(std::to_string(generator_CN0_values.at(current_cn0_idx)) + " dB-Hz Constellation " + "PLL/DLL BW: " + std::to_string(PLL_wide_bw_values.at(config_idx)) + "," + std::to_string(DLL_wide_bw_values.at(config_idx)) + " Hz" + "NAVIC L5 C/A (PRN #" + std::to_string(FLAGS_test_satellite_PRN) + ")");
                                                    g2.set_grid();
                                            ...
                                            g3.set_title("NAVIC L5 C/A tracking CN0 output (PRN #" + std::to_string(FLAGS_test_satellite_PRN) + ")");
                                            g3.set_grid();
...
bool NavicL5CADllPllTrackingTest::save_mat_xy(std::vector<double>& x, std::vector<double>& y, std::string filename)
{
    try
        {
            // WRITE MAT FILE
